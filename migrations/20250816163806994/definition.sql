...
--
-- Class FavoriteLocation as table favorite_location
--
...
--
-- Class LocationReport as table location_report
--
...
--
-- Class ReturnSession as table return_session
--
...
--
-- Class UserBadge as table user_badge
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('pfandler_backend', '20250816163806994', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250816163806994', "timestamp" = now();
